...
ActiveRecord::Schema.define(:version => 20111201075742) do
  ...
  add_index "message_streams", ["name"], :name => "index_message_streams_on_name"
  ...
  add_index "programs", ["name"], :name => "index_programs_on_name", :unique => true
